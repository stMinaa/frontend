...
function Modal({ onClose, title, children }) {
  return (
    <div style={{position:'fixed',top:0,left:0,width:'100vw',height:'100vh',background:'rgba(0,0,0,0.35)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:1000}}>
      <div style={{background:'#fff',minWidth:'320px',maxWidth:'560px',width:'90%',borderRadius:12,boxShadow:'0 10px 40px rgba(0,0,0,0.25)',padding:'24px 24px 28px',position:'relative'}}>
