...
function DirectorProfile({ user, token, onUserUpdate }) {
  ...
  const fullName = `${firstName||''} ${lastName||''}`.trim() || 'Natalija Grujicic';
        ...
        {editing ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px 60px', maxWidth: 800, marginLeft: 40 }}>
            <div>
              ...
              <div style={{ fontSize: 16, color: '#95a5a6' }}>{firstName || 'Natalija'}</div>
            </div>
            <div>
              <div style={{ fontSize: 16, color: '#2c3e50', marginBottom: 8, fontWeight: 500 }}>Prezime</div>
              <div style={{ fontSize: 16, color: '#95a5a6' }}>{lastName || 'Grujicic'}</div>
            </div>
            <div>
              <div style={{ fontSize: 16, color: '#2c3e50', marginBottom: 8, fontWeight: 500 }}>Email</div>
              <div style={{ fontSize: 16, color: '#95a5a6' }}>{user?.email || 'natsel@gmail.com'}</div>
            </div>
            <div>
              <div style={{ fontSize: 16, color: '#2c3e50', marginBottom: 8, fontWeight: 500 }}>Broj telefona</div>
              <div style={{ fontSize: 16, color: '#95a5a6' }}>{mobile || '381245698'}</div>
            </div>
          </div>
        )}
      </div>
