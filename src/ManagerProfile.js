...
function ManagerProfile({ user, token }) {
        ...
        {editing ? (
          <form onSubmit={handleUpdate} style={{ marginLeft: 40 }}>
            ...
            <div style={{ marginTop: 30 }}>
              <button type="submit" disabled={loading} style={{ padding: '12px 30px', background: '#9B7EBD', color: 'white', border: 'none', borderRadius: 6, cursor: 'pointer', marginRight: 10, fontSize: 14 }}>
